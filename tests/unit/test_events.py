...
from agentic_workflow.events import (
    Event, EventType, EventBus, EventManager, event_manager,
    emit_event, subscribe_to_events, emit_agent_started
)
...
class TestIntegrationScenarios:
    ...
    async def test_correlation_id_scenario(self):
        ...
        await manager.emit("correlated.event", "source", {"data": "test"}, correlation_id)
