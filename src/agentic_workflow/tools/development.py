        ...
        capabilities = ToolCapability(
            ...
            input_schema={
                ...
                "properties": {
                    ...
                    "test_method": {"type": "string", "description": "Specific test method to run"},
...
class DependencyManagerTool(Tool):
    ...
    def __init__(self):
        capabilities = ToolCapability(
            ...
            input_schema={
                "type": "object",
                "properties": {
                    "action": {"type": "string", "enum": ["install", "uninstall", "list", "check"]},
                    "package": {"type": "string", "description": "Package name"},
                    "version": {"type": "string", "description": "Package version"},
                    "requirements_file": {"type": "string", "description": "Path to requirements file"}
                },
                "required": ["action"]
            }
        )
        ...
        try:
            if action == "install":
                if requirements_file:
                    ...
                    return {"success": False, "error": "Package or requirements file required for install"}
                    
            elif action == "uninstall":
                if not package:
                    return {"success": False, "error": "Package name required for uninstall"}
    ...
    def validate_inputs(self, inputs: Dict[str, Any]) -> bool:
        """Validate input parameters."""
        return "action" in inputs and inputs["action"] in ["install", "uninstall", "list", "check"]
