    ...
    async def execute(self, inputs: Dict[str, Any], context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            if operation == "read":
                ...
                return {"success": True, "result": f"Written {len(content)} characters to {path}"}
...
class TextProcessingTool(Tool):
    ...
    def create_default(cls):
        ...
        capabilities = ToolCapability(
            ...
            input_schema={
                "operation": {"type": "string", "enum": ["word_count", "line_count", "extract_emails", "uppercase", "lowercase"]},
                "text": {"type": "string"}
            },
            output_schema={
                "success": {"type": "boolean"},
    ...
    def validate_inputs(self, inputs: Dict[str, Any]) -> bool:
        ...
        valid_operations = ["word_count", "line_count", "extract_emails", "uppercase", "lowercase"]
        return inputs["operation"] in valid_operations
...
class DataAnalysisTool(Tool):
    ...
    def create_default(cls):
        ...
        capabilities = ToolCapability(
            ...
            input_schema={
                "operation": {"type": "string", "enum": ["statistics", "filter", "aggregate", "transform"]},
                "data": {"type": "array"},
    ...
    async def execute(self, inputs: Dict[str, Any], context: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        try:
            if operation == "statistics":
                ...
                return {"success": True, "result": {"filtered_data": filtered_data, "count": len(filtered_data)}}
                ...
                if not group_key or not agg_key:
                    return {"success": False, "error": "Group by and aggregate key required"}
                ...
                if transform_type == "to_upper":
                    ...
                    transformed = [str(item).lower() if isinstance(item, str) else item for item in data]
